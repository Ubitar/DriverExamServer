...
/**
 * Created by huangpinzhang on 2018/7/10.
 */
...
public class StringUtils {
    ...
    //double转string，保留多少位数，不自动处理小数的0
    public static String double2StringWithZero(double num, int keep) {
    ...
    //double转string，保留多少位数，处理小数的0
    public static String double2String(double num,int keep){
        StringBuilder builder = new StringBuilder("#");
        if(keep>0) builder.append(".");
        for (int i = 0; i < keep; i++)
            builder.append("#");
